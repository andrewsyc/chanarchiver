        ...
        for i in links:
            ...
            try:
                for image in images:
                    ...
                    image_md5 = md5(os.path.dirname(os.path.realpath(__file__)) + '/' + board + '/' + urls[0] + '/' + image['href'].split(board+'/')[1])
                    print image_url
                    print image_md5
                    ...
                    for thumb in thumbnail:
                        ...
                        thumbnail_md5 = md5(os.path.dirname(os.path.realpath(__file__)) + '/' + board + '/' + urls[0] + '/' + thumb['src'].split(board+'/')[1])
            except:
                pass
            ...
            if post_has_media == 0:
                ...
                query = '''INSERT INTO {0}_mod (threadID, position_in_thread, post_message, local_thumbnail, local_image,
                          thumbnail_md5, image_md5, moderated, approved) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)'''.format(board)
